...
export const getUsersForSidebar = async (req, res)=>{
    try {
        ...
        // Count number of messages not seen and get latest message timestamp
        ...
        const sortedUsers = userWithLastMessage.sort((a, b) => 
            new Date(b.lastMessageTime) - new Date(a.lastMessageTime)
        );
        
        res.json({success: true, users: sortedUsers, unseenMessages})
    } catch (error) {
